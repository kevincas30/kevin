...
d(window.ccv$serverData.settings):jQuery.getJSON(a,function(a,k,h){200==h.status?d(a):c.reject()}).fail(function(){c.reject()});return c.promise()};b.prototype.hasData=function(a){return this._defaultConfigValues.hasOwnProperty(a)};return b}();e.Configuration=f})(com$adobe$ccv$app||(com$adobe$ccv$app={}));
...
!0,this;var a=this._poster.parent().width(),d=this._poster.parent().height(),c=this._poster.find("img"),b=c.get(0),g=b.width,k=b.height,b=a,n=d;if(b!=g||n!=k)n=a/g*k,n>d&&(n=d,b=d/k*g);a=a/2-b/2;c.css("top",(d/2-n/2).toString()+"px");c.css("left",a.toString()+"px");c.css("width",b.toString()+"px");c.css("height",n.toString()+"px");this._poster.css("display","block");return this};b.prototype.hidePoster=function(){LOGGING&&Log.info(b._LOGTAG,"hidePoster");this._shouldShow=!1;this._loadTimer&&(clearTimeout(this._loadTimer),
...
window.top)$(window).on("resize",jQuery.proxy(this._onResize,this));$(window).on("message",jQuery.proxy(this._onPostMessage,this));b=this.render();this.focusableElements=[];this.focusableElements=this.focusableElements.concat(this.playPauseControl.getFocusableElements()).concat(this.progressControl.getFocusableElements()).concat(this.volumeControlNew.getFocusableElements()).concat(this.captionControl.getFocusableElements());DOMUtil.noFullscreenButton()||(this.focusableElements=this.focusableElements.concat(this.screenControl.getFocusableElements()));
...
document.activeElement.classList.contains("captions")?this.captionControl._onClick(a):document.activeElement.classList.contains("fullscreen")?this._onFullscreenVideoContainer():this._onPlayPauseVideoContainer(a):39==b?(this.progressControl.focusTimelineWrap(),this.videoPlayer.getCurrentTime(function(a){a+=com$adobe$ccv$app.Constants.DEFAULT_FAST_FORWARD;var b=c.durationControl.getDuration();a>b&&0.5>a-b&&(a=b);a<=b&&(c._seek(a),c.showControls())})):37==b&&(this.progressControl.focusTimelineWrap(),
this.videoPlayer.getCurrentTime(function(a){a-=com$adobe$ccv$app.Constants.DEFAULT_FAST_FORWARD;0>a&&(a=0);c._seek(a);c.showControls()}));else if(9==b&&this.screenControl._isFullScreen()){a.stopImmediatePropagation();a.preventDefault();a.stopPropagation();this.focusableElements.forEach(function(a){return a.classList.add("keyboardfocus")});var b=this.focusableElements.indexOf(a.target),d=void 0,d=-1!=b?a.shiftKey?0===b?this.focusableElements.length-1:b-1:b===this.focusableElements.length-1?0:b+1:0;
a=this.focusableElements[d];c.showControls();a.focus()}else 9==b&&(this.focusableElements.forEach(function(a){return a.classList.add("keyboardfocus")}),c.showControls())};c.prototype.setupSelectors=function(){var a=this,b=this.$el;this.videoHolder=b.find("#html5-video-holder");this._videoJSElement=b.find("#video-js");this._video=b.find("#video-js_html5_api");this._captions=b.find(".captions");this._$fullScreenElement=this.videoHolder;DOMUtil.isIOSDevice()?this._$fullScreenElement=this.videoHolder.find("video"):
this._$fullScreenElement=this.videoHolder;this._videoHolder=this.videoHolder.get(0);this.controlbarHolder=b.find("#videocontrols");this.controlsRight=b.find(".controlsright");this._controlsRight=this.controlsRight.get(0);this.captionControls=b.find(".captioncontrols");this._captionControls=this.captionControls.get(0);this._$progressHolderNew=b.find(".timelinewrap");this._$volumeHolderNew=b.find(".volumecontrols");this.spinner=b.find("#spinner");this._videoSurface=this.videoHolder.find("#video-surface");
this._loadingSpinner=this._videoSurface.find(".spinnerwrap");this.subtitlesMenu=b.find(".subtitles-menu");var c=-1E3,d=-1E3;b.find("#video-surface").on("mouseenter",function(a){c=d=-1E3}).on("mousedown",function(a){c=a.clientX;d=a.clientY}).on("mouseup",function(b){LOGGING&&-1E3==c&&Log.info(a._LOGTAG,"Mouse up w/o down, this is no click");-1E3!=c&&-1E3!=d&&(c=Math.abs(b.clientX-c),d=Math.abs(b.clientY-d),LOGGING&&20<=c&&Log.info(a._LOGTAG,"Mouse moved, this is no click: delta X="+c),LOGGING&&20<=
d&&Log.info(a._LOGTAG,"Mouse moved, this is no click: delta Y="+d),20>c&&20>d&&a._onPlayPauseVideoContainer(),c=d=-1E3)}).focusin(function(){b.find("#html5-video-holder").addClass("keyboardfocus")}).focusout(function(){b.find("#html5-video-holder").removeClass("keyboardfocus")})};c.prototype.setupDefaults=function(){this._hasSources=!1;this._lastTime=0;this.hasEverPlayed=this._changedQuality=!1;this._autoHideControlsTimer=-1;this._lastClick=DOMUtil.now()};c.prototype.addSubscribers=function(){};c.prototype.render=
function(){this.showLoader()._addVideoSubscribers()._addControlSubscribers()._initializeControls()._initializeVideo()._initializeCaption();return this};c.prototype._initializeCaption=function(){if(0<this._video.prop("textTracks").length){var a=document.createDocumentFragment().appendChild(document.createElement("ul"));a.className="subtitlesmenu";a.appendChild(this.createMenuItem("subtitles-off","","None"));for(var b=0;b<this._video.prop("textTracks").length;b++)"captions"==this._video.prop("textTracks")[b].kind&&
a.appendChild(this.createMenuItem("subtitles-"+this._video.prop("textTracks")[b].language,this._video.prop("textTracks")[b].language,this._video.prop("textTracks")[b].language));this._captionControls.appendChild(a);document.querySelector("#subtitles-off").style.borderBottom="1px solid #909090";return this}document.querySelector(".captions").disabled=!0;document.querySelector(".captions").style.opacity=0.3};c.prototype.createMenuItem=function(a,b,c){var d=this,e=document.createElement("li"),r=e.appendChild(document.createElement("button"));
r.setAttribute("id",a);r.className="captions-button";0<b.length&&r.setAttribute("lang",b);r.value=c;r.setAttribute("data-state","inactive");r.appendChild(document.createTextNode(c));r.addEventListener("click",function(a){return __awaiter(d,void 0,void 0,function(){var a,b,c;return __generator(this,function(g){a=document.querySelectorAll(".captions-button");a.forEach(function(a){a.setAttribute("data-state","inactive");a.classList.remove("button-clicked")});r.classList.add("button-clicked");b=r.getAttribute("lang");
for(c=0;c<this._video.prop("textTracks").length;c++)this._video.prop("textTracks")[c].language===b?(this._video.prop("textTracks")[c].mode="showing",r.setAttribute("data-state","active")):this._video.prop("textTracks")[c].mode="hidden";document.querySelector(".subtitlesmenu").style.display="none";return[2]})})});[].push(r);return e};c.prototype._initializeVideo=function(){var a=this;if(DOMUtil.isIOSDevice()&&!this._options.playVideoOnInit&&this._options.autoPlay){var c=document.querySelector("video");
c.setAttribute("muted","");c.setAttribute("playsinline","");this._$fullScreenElement.get(0).removeAttribute("controls")}this._options.allowairplay&&this._$videoPlayer.setAttr("x-webkit-airplay","allow");this._$videoPlayer.setAttr("preload",this._options.preload);!this._$videoPlayer.getAttr("src")&&this._options.sources&&(LOGGING&&Log.info(this._LOGTAG,"_initializeVideo: _hasSources = true"),this._hasSources=!0);this._hasSources&&1==this._options.sources.length&&this._options.sources[0].src.length&&
...
function(){this.displayPlayIcon();this._dataLoaded=!0;return this.hideLoader()};c.prototype.onVideoTimeUpdate=function(a){this.onVideoProgress(a)};c.prototype.onVideoDurationChange=function(a){this.videoPlayer.getDuration(function(a){this.durationControl.setDuration(a);this.durationControl.setDuration(a);this.progressControl.setDuration(a);this.progressControl.setDuration(a);0<a?(this.progressControl.enable(),this.progressControl.enable()):(this.progressControl.disable(),this.progressControl.disable())})};
c.prototype.onVideoProgress=function(a){var c=this;this._gotDuration||this._setupDurationControl();if(this.playPauseControl.isPlaying()){var d=this.durationControl.getDuration();this.videoPlayer.getCurrentTime(function(a){LOGGING&&!d&&Log.info(c._LOGTAG,"onVideoProgress: duration is null");LOGGING&&!a&&Log.info(c._LOGTAG,"onVideoProgress: current is null");LOGGING&&d&&a&&-1!=c._seekingTo&&Log.info(c._LOGTAG,"onVideoProgress: skipping updates during seeking, "+a+" > "+c._seekingTo);c.durationControl.updateCurrentTime(a);
a-c.previous_time>=c.logging_interval&&(c.previous_time=a,c.sendDunamisEvent(b.ENGAGEMENT,c.percent_played));if(d&&a&&a>=c._seekingTo){var h=a/d;c._seekingTo=-1;c.progressControl.updateProgressBar(h)}c._lastTime=a;c._rewind&&0<=a&&1>a&&(LOGGING&&Log.info(c._LOGTAG,"onVideoProgress: rewind completed"),c._rewind=!1)})}};c.prototype._onVideoComplete=function(a){LOGGING&&Log.info(this._LOGTAG,"_onVideoComplete");this.isVideoCompletelyWatched||(this.isVideoCompletelyWatched=!0,this.sendDunamisEvent(b.COMPLETE));
...
"_onVideoComplete: auto-rewinding"),this.videoPlayer.setCurrentTime(0),this.progressControl.updateProgressBar(0),this.durationControl.updateCurrentTime(0),this.play()):(LOGGING&&Log.info(this._LOGTAG,"_onVideoComplete: showing replay state"),a=this.durationControl.getDuration(),this.progressControl.updateProgressBar(100),this.durationControl.updateCurrentTime(a),this.playPauseControl.showReplayState()))};c.prototype._onVideoError=function(a){};c.prototype._onVideoPause=function(a){LOGGING&&Log.info(this._LOGTAG,
"_onVideoPause");this.playPauseControl.isPlaying()&&this.playPauseControl.showPauseState()};c.prototype._onVideoRewind=function(a){var b=this;LOGGING&&Log.info(this._LOGTAG,"_onVideoRewind");this._rewind=!0;this._seek(0);setTimeout(function(){b.isPlayedAfterPause=!1;b.play();b.isPlayedAfterPause=!0},300)};c.prototype._onWebkitBeginFullscreen=function(a){LOGGING&&Log.info(this._LOGTAG,"_onWebkitBeginFullscreen")};c.prototype._onWebkitEndFullscreen=function(a){LOGGING&&Log.info(this._LOGTAG,"_onWebkitEndFullscreen");
this.volumeControlNew.setVolume(this.videoPlayer.getVolume());window.location.hash="#";window.location.hash="#share";this._$fullScreenElement.get(0).removeAttribute("controls");this._checkReplay();this._updateSize();this.pause()};c.prototype.goFullscreen=function(a){LOGGING&&Log.info(this._LOGTAG,"goFullscreen");a||(a=this._$fullScreenElement.get(0));this._playAfterExitFullscreen=this.playPauseControl.isPlaying();this.videoPlayer.goFullscreen(a)};c.prototype.exitFullscreen=function(){LOGGING&&Log.info(this._LOGTAG,
"exitFullScreen");this.videoPlayer.exitFullscreen();this._checkReplay();this._playAfterExitFullscreen&&(this._playAfterExitFullscreen=!1,this.play());this._updateSize()};c.prototype._checkReplay=function(){if(DOMUtil.isIPhone()||DOMUtil.isIPod()){var a=this,b=this.durationControl.getDuration();this.showControls();this._killAutoHideControls();this.videoPlayer.getCurrentTime(function(c){b&&c&&(0.1>b-c?(LOGGING&&Log.info(a._LOGTAG,"exitFullscreen: showing replay state"),a._playAfterExitFullscreen=!1,
a.hasEverPlayed=!1,b=a.durationControl.getDuration(),a.progressControl.updateProgressBar(100),a.durationControl.updateCurrentTime(b),a.playPauseControl.showReplayState()):(a.progressControl.updateProgressBar(c/b),a.durationControl.updateCurrentTime(c)))})}};c.prototype.changeSize=function(a,b){LOGGING&&Log.info(this._LOGTAG,"changeSize: "+a+", "+b);var c=this.spinner,d=this.$el.width(),e=this.$el.height(),d=a/2-d/2,e=b/2-e/2;LOGGING&&Log.info(this._LOGTAG,"changeSize spinner: "+d+", "+e+"("+c.width()+
", "+c.height()+")");c.css("left",d.toString()+"px");c.css("top",e.toString()+"px");this.videoPlayer.changeSize(a,b);c=this._videoJSElement.offset().top+this._videoJSElement.outerHeight(!0)-this.controlbarHolder.outerHeight(!0);this.progressControl.changeSize(a,b);this.controlbarHolder.width(this.videoPlayer.getSize().width);this.controlbarHolder.css("bottom","");this.controlbarHolder.css("top",c+"px");this.videoHolder.width(a);this.videoHolder.height(b)};c.prototype.getSize=function(){return{width:this.videoHolder.width(),
height:this.videoHolder.height()}};c.prototype._updateSize=function(){var a=DOMUtil.windowInnerWidth(),b=DOMUtil.windowInnerHeight();LOGGING&&Log.info(this._LOGTAG,"_updateSize: using window w="+a+", h="+b);this.changeSize(a,b)};c.prototype._onResize=function(a){LOGGING&&Log.info(this._LOGTAG,"_onResize");this._updateSize()};c.prototype._onPostMessage=function(a){(a=a.originalEvent.data)&&"string"==typeof a&&0==a.indexOf("resize::")&&(LOGGING&&Log.info(this._LOGTAG,"_onPostMessage: "+a),this._updateSize())};
...
(function(e){function f(a){var b=a>>>16;a&=65535;return 0==a?b:b+a/65535}var b=function(){function a(){}a.prototype.parseHeaders=function(a){var b={},c,d,e;if(!a)return b;a.split("\n").forEach(function(a,g,f){e=a.indexOf(":");c=a.substr(0,e).trim().toLowerCase();d=a.substr(e+1).trim();c&&(b[c]=b[c]?b[c]+", "+d:d)});return b};a.prototype.supportsCORS=function(a){var b=$.Deferred();a=function(a,b){var c=new XMLHttpRequest;c.open(a,b,!0);return c}("GET",a);a.onload=function(){b.resolve(!0)};a.onerror=
